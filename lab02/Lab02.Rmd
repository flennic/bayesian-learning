...
sigma_sq_n = nu_n_and_sigma_sq_n / nu_n

sample_prior_model_params = function (nu_n, sigma_sq_n, mu_n, omega_n) {
...
for (i in 1:simulations) {
  simulated_params = sample_prior_model_params(nu_n, sigma_sq_n, mu_n, omega_n)
...
ggplot(df) +
  geom_point(aes(x = time, y = temp), color = "black", fill = "#dedede",
             shape = 21) +
  geom_ribbon(aes(x = time, ymin = lower, ymax = upper), fill = "grey70", alpha = 0.75) +
